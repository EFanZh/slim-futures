...
pin_project_lite::pin_project! {
    pub struct SimpleSelect<Fut1, Fut2> {
        #[pin]
        fut_1: Fut1,
        #[pin]
        fut_2: Fut2,
...
impl<Fut1, Fut2> SimpleSelect<Fut1, Fut2> {
    pub(crate) fn new(fut_1: Fut1, fut_2: Fut2) -> Self {
        Self { fut_1, fut_2 }
    }
}

impl<Fut1, Fut2> Clone for SimpleSelect<Fut1, Fut2>
where
    Fut1: Clone,
    Fut2: Clone,
{
...
impl<Fut1, Fut2> Future for SimpleSelect<Fut1, Fut2>
where
    Fut1: Future,
...
impl<Fut1, Fut2> FusedFuture for SimpleSelect<Fut1, Fut2>
where
    Fut1: FusedFuture,
...
pub fn simple_select<Fut1, Fut2>(fut_1: Fut1, fut_2: Fut2) -> SimpleSelect<Fut1, Fut2>
where
    Fut1: Future,
    Fut2: Future<Output = Fut1::Output>,
{
    support::assert_future::<_, Fut1::Output>(SimpleSelect::new(fut_1, fut_2))
}
...
mod tests {
    ...
    #[tokio::test]
    async fn test_simple_select_clone() {
        let future = future::simple_select(future::ready(2), future::ready(3));
    ...
    #[tokio::test]
    async fn test_simple_select_fused_future() {
        ...
        assert!(!future::simple_select(pending(), pending()).is_terminated());
        assert!(future::simple_select(pending(), terminated()).is_terminated());
        assert!(future::simple_select(terminated(), pending()).is_terminated());
        assert!(future::simple_select(terminated(), terminated()).is_terminated());
    }

    #[tokio::test]
    async fn test_simple_select_is_slim() {
        ...
        let future = future::simple_select(make_base_future_1(), make_base_future_2());
