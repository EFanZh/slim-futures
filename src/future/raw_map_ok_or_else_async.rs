...
mod tests {
    ...
    async fn test_raw_map_ok_or_else_async() {
        let future_1 = ok::ok_by_copy::<_, u32>(2).slim_raw_map_ok_or_else_async(plus_3, plus_4);
        let future_2 = err::err_by_copy::<_, u32>(2).slim_raw_map_ok_or_else_async(plus_3, plus_4);
    ...
    async fn test_raw_map_ok_or_else_async_clone() {
        let future = ok::ok_by_copy::<_, u32>(2).slim_raw_map_ok_or_else_async(plus_3, plus_4);
    ...
    async fn test_raw_map_ok_or_else_async_fused_future() {
        let mut future = futures_util::future::ok::<_, u32>(2).slim_raw_map_ok_or_else_async(plus_3, plus_4);
    ...
    async fn test_raw_map_ok_or_else_async_is_slim() {
        let make_base_future = || ok::ok_by_copy::<_, NonZeroU32>(NonZeroU32::new(2).unwrap());
        let base_future = make_base_future();
        let f = |_| future::lazy(|_| 3);
