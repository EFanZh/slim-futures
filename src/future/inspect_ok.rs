...
impl<Fut, F, T, E> Future for InspectOk<Fut, F>
where
...
impl<Fut, F, T, E> FusedFuture for InspectOk<Fut, F>
where
...
mod tests {
    ...
    async fn test_inspect_ok() {
        ...
        let future_1 = future::ready(Ok::<usize, usize>(2)).slim_inspect_ok(f);
        let future_2 = future::ready(Err::<usize, usize>(3)).slim_inspect_ok(f);
    ...
    async fn test_inspect_ok_clone() {
        ...
        let future = future::ready(Ok::<usize, usize>(3)).slim_inspect_ok(|&value| {
